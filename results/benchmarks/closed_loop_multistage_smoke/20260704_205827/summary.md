# Closed-loop benchmark -- run 20260704_205827

Config: model **vjepa2-ac-vitg (ViT-g encoder 1.01B + AC predictor 305M)**, protocol **multistage**, samples **200**, cem_steps **10**, rollout **T=2**, topk **10**, maxnorm **0.05 m**, dtype **bf16**, **5 trials/task**, seed 0.
...
- reach mean steps 5.8 (V-JEPA 4.8), mean CEM 24.3 s/step

| task | n | mean err (cm) | median | p90 | @6cm | @5cm | @3cm | @2cm |
|---|---|---|---|---|---|---|---|---|
| **grasp_lift** | 5 | 1.7 | 2.0 | 2.5 | 80% | 80% | 80% | 60% |

- grasp_lift failures: {'missed': 1}
- grasp_lift mean steps 12.4 (V-JEPA 8.4), mean CEM 24.3 s/step

| task | n | mean err (cm) | median | p90 | @10cm | @6cm | @3cm | @1.5cm |
|---|---|---|---|---|---|---|---|---|
| **place** | 5 | 16.6 | 16.9 | 19.5 | 0% | 0% | 0% | 0% |

- place failures: {'outside_zone': 5}
- place mean steps 23.0 (V-JEPA 14.0), mean CEM 24.3 s/step
