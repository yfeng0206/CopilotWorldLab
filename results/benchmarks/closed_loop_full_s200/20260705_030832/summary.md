# Closed-loop benchmark -- run 20260705_030832
...
|---|---|---|---|---|---|---|---|---|
| **grasp_lift** | 50 | 1.9 | 1.7 | 3.1 | 54% | 54% | 52% | 36% |

- grasp_lift failures: {'missed': 22, 'tipped': 1}
- grasp_lift mean steps 9.9 (V-JEPA 5.9), mean CEM 25.0 s/step
