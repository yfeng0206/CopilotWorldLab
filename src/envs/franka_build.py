...
# Per-object rest half-height (for placing the object resting on the table) and grasp style.
OBJECT_SPECS = {
    "cube": {"rest_half_z": CUBE_HALF, "grasp": "top"},
    "box": {"rest_half_z": BOX_HALF[2], "grasp": "top"},
    "cup": {"rest_half_z": CUP_HALF_H, "grasp": "rim"},
}
